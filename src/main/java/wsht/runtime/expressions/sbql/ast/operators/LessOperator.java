...
*/
public class LessOperator extends BinaryExpression implements IOperator {

	public LessOperator(Expression leftExpression, Expression rightExpression) {
	...
	public void eval() {
		...
		if (right instanceof IntegerResult && left instanceof IntegerResult) {
			...
			throw new SBQLEvalException("LessOperator.eval: blad typu");
		}
