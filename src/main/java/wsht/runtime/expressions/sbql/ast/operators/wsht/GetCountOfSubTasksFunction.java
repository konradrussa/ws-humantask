 ...
 */
public class GetCountOfSubTasksFunction extends WSHTOperator implements IOperator {
	
	public GetCountOfSubTasksFunction(Expression expression) {
	...
	public void eval() {
		...
		//TODO: implement GetCountOfSubTasksFunction eval
	...
	public void accept(ASTVisitor visitor) {
		visitor.visitGetCountOfSubTasks(this);
	}
