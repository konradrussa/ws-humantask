...
*/
public class GreaterOperator extends BinaryExpression implements IOperator {

	public GreaterOperator(Expression leftExpression, Expression rightExpression) {
	...
	public void eval() {
		...
		if (right instanceof IntegerResult && left instanceof IntegerResult) {
			...
			throw new SBQLEvalException("GreaterOperator.eval: blad typu");
		}
