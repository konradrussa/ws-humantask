...
public class GetCountOfSubTasksFunc implements XPathFunction {
	...
	final static QName functionName = new QName("http://docs.oasis-open.org/ns/bpel4people/ws-humantask/200803", "getCountOfSubTasks", "htd");
