...
import wsht.runtime.expressions.sbql.ast.terminals.DateTerminal;
...
import wsht.runtime.expressions.sbql.ast.terminals.LongTerminal;
...
public class Interpreter implements ASTVisitor {
	...
	public void visitDateTerminal(DateTerminal dateTerminal) {
		DateResult result = new DateResult(dateTerminal.getValue());
		QRES.getInstance().push(result);
		
	}

	public void visitLongTerminal(LongTerminal longTerminal) {
		LongResult result = new LongResult(longTerminal.getValue());
		QRES.getInstance().push(result);
