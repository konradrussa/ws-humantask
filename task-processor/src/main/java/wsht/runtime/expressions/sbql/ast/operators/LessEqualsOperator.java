...
*/
public class LessEqualsOperator extends BinaryExpression implements IOperator {

	public LessEqualsOperator(Expression leftExpression, Expression rightExpression) {
	...
	public void eval() {
		...
		if (right instanceof IntegerResult && left instanceof IntegerResult) {
			...
			throw new SBQLEvalException("LessEqualsOperator.eval: blad typu");
		}
		QRES.getInstance().push(result);
	}

	public void accept(ASTVisitor visitor) {
		visitor.visitLessEqualsExpression(this);
	}
