 ...
 */
public class LeastFrequentOccurenceFunction extends UnaryExpression implements IOperator {

	
	public LeastFrequentOccurenceFunction(Expression expression) {
	...
	public void eval() {
		...
		if(res instanceof BagResult) {
			...
			throw new SBQLEvalException("LeastFrequentOccurenceFunction.eval - powinien byc node-set");
		}
		
		String A[] = stringList.toArray(new String[0]);
		eres.setValue(OperatorUtils.occurence(A, false));
	...
	public void accept(ASTVisitor visitor) {
		visitor.visitLeastFrequentOccurence(this);		
	}
