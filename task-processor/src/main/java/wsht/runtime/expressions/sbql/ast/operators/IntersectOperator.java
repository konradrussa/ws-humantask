...
� minus, intersect, in � tradycyjne operatory zbiorowe.
	Ewaluacja: podobnie jak w union. 
		W celu porownania wartosci operator moze dokonywac dereferencji rezultatow.
 */

/*
 * Constructs an organizationalEntity containing every user that occurs in both set1 and set2, 
...
public class IntersectOperator extends BinaryExpression implements IOperator {

	public IntersectOperator(Expression leftExpression, Expression rightExpression) {
