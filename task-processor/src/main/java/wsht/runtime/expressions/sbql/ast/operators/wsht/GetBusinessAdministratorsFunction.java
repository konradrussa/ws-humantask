...
public class GetBusinessAdministratorsFunction extends WSHTOperator implements IOperator {
	...
	public void eval() {
		...
		if(res == null) {
			BagResult resOut = ENVS.getInstance().bind(TaskInstance._F_businessAdministratorsField);
			...
			throw new SBQLEvalException("GetBusinessAdministratorsFunction.eval - nieobslugiwana ilosc agrumentow");
		}
