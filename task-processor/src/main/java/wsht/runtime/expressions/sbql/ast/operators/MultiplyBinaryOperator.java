...
*/
public class MultiplyBinaryOperator extends BinaryExpression implements IOperator {

	public MultiplyBinaryOperator(Expression leftExpression, Expression rightExpression) {
	...
	public void accept(ASTVisitor visitor) {
		visitor.visitMultiplyBinaryExpression(this);
	}
