...
*/
public class MinusBinaryOperator extends BinaryExpression implements IOperator {

	public MinusBinaryOperator(Expression leftExpression, Expression rightExpression) {
	...
	public void eval() {
		...
		if (right instanceof IntegerResult && left instanceof IntegerResult) {
			...
			throw new SBQLEvalException("MinusBinaryOperator.eval: blad typu");
		}
		QRES.getInstance().push(result);
	}

	public void accept(ASTVisitor visitor) {
		visitor.visitMinusBinaryExpression(this);
